...
const TRANSLATIONS = {
  'pt': {
    ...
    label_company_logo: 'Logo da Empresa (URL)',
    label_opening_hours: 'Horário de Funcionamento',
    label_rest_interval: 'Intervalo de Descanso',
    label_professional: 'Profissional',
    label_payment_method: 'Forma de Pagamento',
    label_duration: 'Duração (min)',
    label_services: 'Serviços',
    label_photo: 'Foto (URL)',
    label_start: 'Início',
    label_end: 'Fim',
    label_assigned_services: 'Serviços do Profissional',
    pay_cash: 'Dinheiro',
    ...
    units: 'Unidades',
    label_unit: 'Unidade',
    unit_name_label: 'Nome da Unidade *',
    unit_email_label: 'E-mail',
    unit_address_label: 'Endereço',
    unit_neighborhood_label: 'Bairro',
    unit_zip_label: 'CEP',
    unit_city_label: 'Cidade',
    unit_state_label: 'UF',
  ...
  'en': {
    ...
    label_rest_interval: 'Rest Interval',
    label_professional: 'Professional',
    label_payment_method: 'Payment Method',
    label_duration: 'Duration (min)',
    label_services: 'Services',
    label_photo: 'Photo (URL)',
    label_start: 'Start',
    label_end: 'End',
    label_assigned_services: 'Professional Services',
    pay_cash: 'Cash',
    ...
    unit_email_label: 'E-mail',
    unit_address_label: 'Address',
    unit_neighborhood_label: 'Neighborhood',
    unit_zip_label: 'ZIP Code',
    unit_city_label: 'City',
